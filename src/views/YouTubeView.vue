...
<template>
  <div class="p-4 sm:p-6 space-y-4 max-w-4xl mx-auto">
    <h1 class="text-lg sm:text-xl font-semibold">YouTube</h1>
    <p class="text-gray-500">Paste a YouTube URL or Video ID, then click Play.</p>
    ...
    <YouTubeRecommendations :keyword="selectedKeyword" />
  </div>
